...
class ZI_buy(Agent):
    ...
    def __init__(self, unique_id, model, valuation, eq_surplus, commodities):
        ...
        self.budget = valuation * commodities
    ...
    def reset_agent(self):
        ...
        self.budget = self.valuation * self.tot_commodities
        self.offer = 0
...
class ZI_C_buy(ZI_buy):
    ...
    def willing_to_shout(self):
        ...
        is_endowed = self.valuation > self.model.best_bid
    ...
    def offer_price(self):
        ...
        max_bid = self.valuation if self.budget > self.valuation else self.budget
...
class ZIP_buy(ZI_C_buy):
    ...
    def __init__(self, unique_id, model, valuation, eq_surplus, commodities, params):
        ...
        self.profit_margin = random.uniform(*params["profit_margin_buyers"])
    ...
    def margin_within_bounds(self):
        ...
        """
        # if self.profit_margins[self.quantity % self.tot_commodities] < -1:
        #     self.profit_margins[self.quantity % self.tot_commodities] = -1
        # elif self.profit_margins[self.quantity % self.tot_commodities] > 0:
    ...
    def update_params(self):
        ...
        if self.model.transaction_possible:
            ...
            # lower profit margin
            if side_last_offer == "buyer" and offer <= self.model.agent_last_offer.offer and self.in_market:
...
class Kaplan_buy(ZI_buy):
    ...
    def willing_to_shout(self):
        ...
        if best_ask != math.inf:
            ...
            self.most = min(best_ask, self.valuation - 1)
        else:
        ...
        # is_endowed = self.valuation >= self.most
    ...
    def is_small_spread(self):
        ...
        # valuation = self.prices[self.quantity]
        expected_profit = self.valuation - self.model.best_ask > (1 - self.profit_perc) * self.valuation
